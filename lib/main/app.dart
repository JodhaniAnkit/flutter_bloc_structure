...
import 'package:bloc_structure/routes/go_router_routes/app_go_router_config.dart';
...
class App extends StatelessWidget {
  ...
  ThemeData _buildDarkTheme() => ThemeData(useMaterial3: false, brightness: Brightness.dark, primarySwatch: Colors.blue);

  ThemeData _buildLightTheme() => ThemeData(useMaterial3: false, brightness: Brightness.light, colorSchemeSeed: Colors.brown);
